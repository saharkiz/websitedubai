...
<html lang="en">
   <head>
      ...
      <meta property="og:site_name"  content="IT Consultant in Dubai">
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-70163755-2"></script>
      <script>
         window.dataLayer = window.dataLayer || [];
         function gtag(){dataLayer.push(arguments);}
         gtag('js', new Date());

         gtag('config', 'UA-70163755-2');
      </script>
      <meta name="google-site-verification" content="ZpjZjnq2jqMdsIJyhiv-E4eHQejOHRasxMGV2Xqp4R8" />
   </head>
   <body>
         ...
         <div class="container">
            <div class="row d-flex">
               <div class="col-md-5 order-md-last wrap-about align-items-stretch">
                  <div class="wrap-about-border ftco-animate">
                     ...
                     <div class="text">
                        ...
                        <p>
                           We have been a software company in Dubai for 10 years offering affordable website development while also keeping up with the technology as the years go by.
                        </p>
               ...
               <div class="col-md-7 wrap-about pr-md-4 ftco-animate">
                  ...
                  <p>Being a software Development Company for more than 10 years in Dubai and working with a wide range of clients, we tailor-make according to your needs.</p>
                  <div class="row mt-5">
                     <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        <div class="services text-center">
                           ...
                           <div class="text media-body">
                              ...
                              <p>Our e-commerce software solutions including Extensive features, innovative design, and Easy Product and Order Management System help reach more customers online.</p>
                           </div>
                        </div>
                        <div class="services text-center">
         ...
         <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
               <div class="col-md-7 text-center heading-section heading-section-white ftco-animate fadeInUp ftco-animated">
                  <h2 class="mb-4">Our Best Pricing Packages</h2>
                  <p></p>
               </div>
            </div>
            <div class="row no-gutters d-flex">
               <div class="col-lg-3 col-md-6 ftco-animate fadeInUp ftco-animated">
                  <div class="block-7 bg-light">
                     <div class="text-center">
                        <h2 class="heading">Dynamic Website</h2>
                        <span class="price">
                            <span class="number">5,500<small class="per">AED</small></span>
                           <span class="excerpt d-block">One time fee</span>
                           <h3 class="heading-2 mb-3">Customized CMS</h3>
                           <ul class="pricing-text mb-4">
                              <li><strong>Customized Design</strong> Template</li>
                              <li><strong>Up to </strong> 7 Pages</li>
                              <li><strong>3 Iteration on </strong> the home page</li>
                              <li><strong>2 Iteration on </strong> the inside pages</li>
                              <li>Responsive Website</li>
                              <li><strong>10 </strong> Stock Photos</li>
                              <li><strong>AED 399 Additional</strong> .com Domain, Hosting & 2 Emails for 1 Year</li>
                              <li><strong>AED 500 Additional</strong> Basic SEO</li>
                           </ul>
                        </span>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6 ftco-animate fadeInUp ftco-animated">
                  <div class="block-7">
                     <div class="text-center">
                       <h2 class="heading">Company Website</h2>
                       <span class="price">
                           <span class="number">3,500<small class="per">AED</small></span>
                          <span class="excerpt d-block">One time fee</span>
                          <h3 class="heading-2 mb-3">Wordpress CMS</h3>
                          <ul class="pricing-text mb-4">
                             <li><strong>Pre selected</strong> Template</li>
                             <li><strong>Up to </strong> 4 Pages</li>
                             <li><strong>3 Iteration on </strong> the home page</li>
                             <li><strong>2 Iteration on </strong> the inside pages</li>
                             <li>Responsive Website</li>
                             <li><strong>10 </strong> Stock Photos</li>
               ...
               <div class="col-lg-3 col-md-6 ftco-animate fadeInUp ftco-animated">
                  <div class="block-7 active">
                     <div class="text-center">
                        <h2 class="heading">eCommerce Expert</h2>
                        <span class="price"><span class="number">8,200<small class="per">AED</small></span></span>
                        <span class="excerpt d-block">One time fee</span>
                        <h3 class="heading-2 mb-3">Customized eCommerce</h3>
                        <ul class="pricing-text mb-4">
                          <li><strong>Pre selected</strong> Template</li>
                          <li><strong>Unlimited</strong> products</li>
                          <li><strong>Order & Sales</strong> management</li>
                          <li><strong>COD & Paypal </strong> Payment gateway</li>
                          <li><strong>Coupons</strong> and gift vouchers</li>
                          <li>Guest checkout</li>
                          <li>Search engine friendly URLs</li>
                          <li><strong>AED 599 Additional</strong> .com Domain, Hosting & 2 Emails for 1 Year</li>
                        </ul>
               ...
               <div class="col-lg-3 col-md-6 ftco-animate fadeInUp ftco-animated">
                  <div class="block-7">
                     <div class="text-center">
                        <h2 class="heading">eCommerce Magento</h2>
                        <span class="price"><span class="number">12,000<small class="per">AED</small></span></span>
                        <span class="excerpt d-block">One time fee</span>
                        <h3 class="heading-2 mb-3">Magento 2.3 eCommerce</h3>
                        <ul class="pricing-text mb-4">
                          <li><strong>Pre selected</strong> Template</li>
                          <li><strong>Unlimited</strong> products</li>
                          <li><strong>Order & Sales</strong> management</li>
         ...
         <div class="container">
            <div class="row justify-content-center mb-5 pb-2">
               <div class="col-md-8 text-center heading-section ftco-animate">
                  ...
                  <p>
                     Our versatility isn't limited to different sectors or software, but also the areas we cater to. Our Company can help build websites for the following areas: - Dubai - Abudhabi - Sharjah - Ajman - Al Ain - Ras Al Khaimah - Fujairah - Umm Al Quwain
                  </p>
               </div>
            </div>
            ...
            <div class="row no-gutters">
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-2.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for blue wing dubai rent a car" href="/images/project-2.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
                        <h3><a title="IT consultant in dubai" href="https://bluewingdubai.com">Blue Wing Dubai</a></h3>
               ...
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-1.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for the little things" href="/images/project-1.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
                        <h3><a title="IT consultant in dubai" href="https://littlethingsme.com">The Little Things</a></h3>
                        <span>Web Design</span>
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-3.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai bermuda diving center" href="/images/project-3.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
                        <h3><a title="IT consultant in dubai" href="https://scubadiving.ae">Bermuda diving center</a></h3>
                        <span>Web Design</span>
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-4.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for rubik service" href="/images/project-4.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
                        <h3><a title="IT consultant in dubai" href="https://rubikservice.com">Rubik Service</a></h3>
                        <span>Web Design</span>
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-5.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for seedology" href="/images/project-5.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
               ...
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-6.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for kikkerland" href="/images/project-6.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
               ...
               <div class="col-md-3">
                  <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/project-8.jpg);">
                     <div class="overlay"></div>
                     <a title="IT consultant in dubai for dari home" href="/images/project-8.jpg" class="btn-site d-flex align-items-center justify-content-center"><span class="icon-subdirectory_arrow_right"></span></a>
                     <div class="text text-center p-4">
                        <h3><a title="IT consultant in dubai" href="#">Dari Home</a></h3>
                        <span>Web Design</span>
                     </div>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row justify-content-center mb-5">
               <div class="col-md-8 text-center heading-section ftco-animate">
                  ...
                  <p>We discuss your business module and provide a plan that best evolves your business online and creates maximum ROI</p>
               </div>
            </div>
                     ...
                     <div class="item">
                        <div class="testimony-wrap d-flex">
                           ...
                           <div class="text pl-4">
                              ...
                              <p>We love our new booking system</p>
                              <p class="name">Scubadiving.ae</p>
                     ...
                     <div class="item">
                        <div class="testimony-wrap d-flex">
                           ...
                           <div class="text pl-4">
                              ...
                              <p>Amazing Work on our website. our sales have increased online</p>
                              <p class="name">Littlethingsme.com</p>
                     ...
                     <div class="item">
                        <div class="testimony-wrap d-flex">
                           ...
                           <div class="text pl-4">
                              ...
                              <p>Our website has increased our booking and online presence</p>
                              <p class="name">Bluewingdubai.com</p>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  <p>
                     Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by Aresh
                  </p>
               </div>
            </div>
         </div>
